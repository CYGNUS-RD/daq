...
int v1190_dummyWrite16(MVME_INTERFACE *mvme, DWORD base, WORD value)
{
    int cmode, nbytes;
...
/*****************************************************************/
void v1190_EdgResolutionSet(MVME_INTERFACE *mvme, DWORD base, V1190_EDGE_RESOL le)
{
  int   cmode, value;
  ...
  if ((le == V1190_ED_Res_100PS) ||
    ...
    //printf("le:%x\n", le);
    value = v1190_MicroWrite(mvme, base, V1190_EDGE_RESOLUTION_WO);
    value = v1190_MicroWrite(mvme, base, (WORD)le);
  } else {
    printf("Wrong Leading Edge Resolution -> Set at default (100ps)\n");
    value = v1190_MicroWrite(mvme, base, V1190_EDGE_RESOLUTION_WO);
    value = v1190_MicroWrite(mvme, base, V1190_ED_Res_100PS);
  }
  mvme_set_dmode(mvme, cmode);
}
...
void v1190_SubtractTriggerTimeON(MVME_INTERFACE *mvme, DWORD base)
{
  ...
  value = v1190_MicroWrite(mvme, base, (WORD) 0x1400);
...
void v1190_WidthSet(MVME_INTERFACE *mvme, DWORD base, WORD width)
{
  ...
  value = v1190_MicroWrite(mvme, base, (WORD) (width&0x0FFF));
...
void v1190_WidthSet_ns(MVME_INTERFACE *mvme, DWORD base, unsigned int width)
{
    ...
    v1190_WidthSet(mvme,base,widthVal);
}
...
void v1190_OffsetSet_ns(MVME_INTERFACE *mvme, DWORD base, int offset) {
    ...
    v1190_OffsetSet(mvme, base, offVal);

}

/*****************************************************************/
void v1190_SetEdgeDetection(MVME_INTERFACE *mvme, DWORD base, V1190_EDGE_MODE ed)
{
  int   cmode, value;
  ...
  if ((ed == V1190_ED_Pair) ||
      ...
      (ed == V1190_ED_Leading) ||
      (ed == V1190_ED_TRandLE)) {
    value = v1190_MicroWrite(mvme, base, V1190_EDGE_DETECTION_WO);
    WORD edVal = ed;
    value = v1190_MicroWrite(mvme, base, edVal);
  } else {
    //printf("Wrong Edge Detection configuration -> Set to Pair\n");
    value = v1190_MicroWrite(mvme, base, V1190_EDGE_DETECTION_WO);
    value = v1190_MicroWrite(mvme, base, (WORD)V1190_ED_Pair);
  }
  mvme_set_dmode(mvme, cmode);
}
...
*/
int v1190_Status(MVME_INTERFACE *mvme, DWORD base, V1190Type type)
{
  WORD  i, code, pair=0;
  int   cmode, value;
  ...
  code = 0x4700;
  for (i=0; i<nBlock ; i++) {
    value = v1190_MicroWrite(mvme, base, code+i);
    value = v1190_MicroRead(mvme, base);
    value = (v1190_MicroRead(mvme, base)<<16) | value;
  ...
  //-------------------------------------------------
  printf("\n--- Bus Error Enable? : %s\n",(v1190_SatusBusError(mvme, base)) ? "y" : "n");
...
void v1190_SetDuoubleHitsRes_ns(MVME_INTERFACE *mvme, DWORD base, int resol){
    int cmode = 0;
    WORD value = 0x0000;
...
void v1190_SetMaxNOfHitsPerEve(MVME_INTERFACE *mvme, DWORD base, V1190_MAXHITS_PEREVENT maxHits){
    int cmode = 0;
    mvme_get_dmode(mvme, &cmode);
    mvme_set_dmode(mvme, MVME_DMODE_D16);
    v1190_MicroWrite(mvme, base, (WORD) (0x3300));
    v1190_MicroWrite(mvme, base, (WORD) maxHits);
    mvme_set_dmode(mvme, cmode);
}
...
void v1190_EnableERRORMark(MVME_INTERFACE *mvme, DWORD base) {
    ...
    mvme_get_dmode(mvme, &cmode);
    mvme_set_dmode(mvme, MVME_DMODE_D16);
    v1190_MicroWrite(mvme, base, (WORD) (0x3500));
    mvme_set_dmode(mvme, cmode);
}
...
void v1190_EnableHeaderAndTrailer(MVME_INTERFACE *mvme, DWORD base) {
    ...
    mvme_get_dmode(mvme, &cmode);
    mvme_set_dmode(mvme, MVME_DMODE_D16);
    v1190_MicroWrite(mvme, base, (WORD) (0x3000));
    mvme_set_dmode(mvme, cmode);
}
